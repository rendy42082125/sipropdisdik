...
class ProposalKecamatanController extends Controller
{
    public function kecamatan1()
    {
        ...
        return view('admin.proposal.kecamatan1', compact('proposals'));
    }
    ...
    public function kecamatan2()
    {
        ...
        return view('admin.proposal.kecamatan2', compact('proposals'));
    }
    ...
    public function kecamatan3()
    {
        ...
        return view('admin.proposal.kecamatan3', compact('proposals'));
    }
    ...
    public function kecamatan4()
    {
        ...
        return view('admin.proposal.kecamatan4', compact('proposals'));
    }
    ...
    public function kecamatan5()
    {
        ...
        return view('admin.proposal.kecamatan5', compact('proposals'));
    }
}
