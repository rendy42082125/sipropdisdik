...
class ProposalController extends Controller
{
    ...
    {
        $proposals = Proposal::with(['photos', 'files', 'status', 'sekolah','user'])->get();
        return view('staff.proposal.index', compact('proposals'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.proposal.create', compact('sekolahList', 'statusList', 'kecamatanList'));
    }    
    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('staff.proposal.index')->with('success', 'Proposal berhasil dibuat.');
}
    ...
    public function show(Proposal $proposal)
    {
        ...
        return view('staff.proposal.show', compact('proposal'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff.proposal.edit', compact('proposal', 'sekolahList', 'statusList', 'kecamatanList'));
    }
    ...
    public function update(Request $request, Proposal $proposal)
{
    ...
    return redirect()->route('staff.proposal.index')->with('success', 'Proposal berhasil diperbarui.');
}
    ...
    public function destroy(Proposal $proposal)
    {
        ...
        return redirect()->route('staff.proposal.index')->with('success', 'Proposal berhasil dihapus.');
    }
    ...
    public function sendWhatsAppMessage($proposalId)
{
  ...
  if (curl_errno($curl)) {
      ...
      return redirect()->route('staff.proposal.index')->with('error', 'Gagal mengirim pesan: ' . $error_msg);
  }
  curl_close($curl);
  ...
  if ($response) {
      ...
      if (isset($responseDecoded['status']) && $responseDecoded['status'] == 'success') {
          return redirect()->route('staff.proposal.index')->with('success', 'Pesan WhatsApp berhasil dikirim.');
      } else {
          // Jika respon tidak sesuai dengan yang diharapkan
          return redirect()->route('staff.proposal.index')->with('error', 'Gagal mengirim pesan WhatsApp.');
      }
  }

  // Redirect default jika tidak ada respon atau respon tidak dapat di-decode
  return redirect()->route('staff.proposal.index')->with('error', 'Tidak ada respon dari API.');
}
}
