...
<a class="btn btn-success mb-3" href="{{ route('admin.sekolah.create') }}">Tambah Sekolah</a>
                    ...
                    @foreach ($sekolah as $s)
                        @if ($s->id_sekolah != 1)
                            <tr>
                                ...
                                <td>{{ $s->jenis->name }}</td>
                                <td>
                                    <a class="btn btn-primary" href="{{ route('admin.sekolah.edit', $s->id_sekolah) }}">Edit</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="delete-form-{{ $s->id_sekolah }}" action="{{ route('admin.sekolah.destroy', $s->id_sekolah) }}" method="POST">
                    @csrf
                    @method('DELETE')
