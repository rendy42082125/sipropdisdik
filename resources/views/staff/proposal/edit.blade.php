...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('staff.proposal.update', $proposal->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="photos">
                            @foreach($proposal->photos as $photo)
                                <div class="photo-item">
                                    ...
                                    <a href="{{ route('staff.proposal.downloadPhoto', $photo->id) }}" class="btn btn-primary mt-2">Download</a>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <ul>
                            @foreach($proposal->files as $file)
                                <li>
                                    <a href="{{ route('staff.proposal.downloadFile', $file->id) }}" class="btn btn-primary">{{ $file->filename }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
